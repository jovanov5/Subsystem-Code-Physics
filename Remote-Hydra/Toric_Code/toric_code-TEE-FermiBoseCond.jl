...
function main(L::Integer, d::Integer, p_f_max::Float64, n_pf::Integer, p_b_max::Float64, n_pb::Integer, t_final::Integer, n_t::Integer, exp_index::Integer)
...
exp_index = parse(Int, ARGS[9])
main(L, d, p_f, n_pf, p_b, n_pb, t_final, n_t, exp_index);
