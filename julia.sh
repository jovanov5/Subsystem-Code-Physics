#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Sun  2 Jun 15:21:52 BST 2024      
date_start=`date +%s`
